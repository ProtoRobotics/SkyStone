...
public class SkystoneSensor {    private ElapsedTime runtime = new ElapsedTime();
    ...
    public SkystoneSensor(int cameraMonitorViewId)
    {
        ...
        phoneCam.setPipeline(new SkystoneSensor.StageSwitchingPipeline());//different stages
    ...
    static class StageSwitchingPipeline extends OpenCvPipeline
    {
        ...
        private SkystoneSensor.StageSwitchingPipeline.Stage stageToRenderToViewport = SkystoneSensor.StageSwitchingPipeline.Stage.detection;
        private SkystoneSensor.StageSwitchingPipeline.Stage[] stages = SkystoneSensor.StageSwitchingPipeline.Stage.values();
